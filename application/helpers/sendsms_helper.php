...
// it takes following parameter as an array and return sms id for successfully delivered of sms otherwise return fasle 
 ...
 if(!function_exists("sendsms"))
 {
    ...
    $config = array();
        $config['url']     = "http://smsport.biz/API/WebSMS/Http/v1.0a/index.php";
   /* $config['url']     = "http://smsport.biz/API/WebSMS/Http/v1.0a/index.php?username=dcount&password=dcountnow123&sender=DCOUNT&to=8052068888&message=Hello+Test+Message";*/
/*  $config['url']     = "http://sms.irebelwebtech.com/API/WebSMS/Http/v1.0a/index.php"; */
 	$config['username']    = "dcount";         // userid of sms gateway login
 	$config['password']     = "dcountnow123";  // password of sms gateway login
 	$config['sender']     = "DCOUNT";           // approved sender id

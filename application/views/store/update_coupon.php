      ...
      <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <?php $attributes = array('class' => 'form-horizontal', 'id' => 'myform');
                                echo form_open_multipart('dcount/update_coupon', $attributes);?>
                              <div class="control-group">
                                <label class="control-label">Coupon Name :</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="coupon_name" value="<?php  echo $coupon_list['cop_name'] ?>" required>
                                </div>
                            </div>
                           <div class="control-group">
                                <label class="control-label">Discount %:</label>
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="discount" name="dis" value="<?php  echo $coupon_list['dis'] ?>" required>
                                </div>
                            </div>
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" placeholder="store Type" name="coupon_code" value="<?php  echo $coupon_list['cop_code'] ?>">
                                </div>
                            </div>
                       	<!--	<div class="control-group">
                                <div class="controls">
                            ...
                            <div class="control-group">
                               ...
                               <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="date" class="span11" name="expiry_date" >
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span11" name="coupon_desc"><?php  echo $coupon_list['cop_desc'] ?></textarea>
                                </div>
                            </div>
                            <?php  echo $coupon_list['cop_d_day'] ?>
                                ...
                                <div class="controls">
                                    ...
                                    <option value="0" <?php if($coupon_list['cop_d_day']==0){echo 'selected';} ?>>No</option>
                                      <option value="1"  <?php if($coupon_list['cop_d_day']==1){echo 'selected';} ?>>Yes</option>
                                    </select>
                                </div>
                            </div>
                                   <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <option value="0"  <?php if($coupon_list['cop_featured']==0){echo 'selected';} ?>>No</option>
                                      <option value="1"  <?php if($coupon_list['cop_featured']==1){echo 'selected';} ?>>Yes</option>
                                    </select>
                                </div>
                            </div>

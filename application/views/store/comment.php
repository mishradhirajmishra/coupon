...
-                                 <?php foreach($comment as $row){?>
         ...
         <tr >
                                    ...
                                    <td> <?php if( $row['status']==0){echo'<button class="btn btn-info">INACTIVE</button> ';} else {echo'<button class="btn btn-success">ACTIVE</button> ';}?> </td>
                                      <td> <a href="<?php echo base_url();?>index.php/admin/edit_comment/<?php echo $row['id'] ?>" class="btn btn-primary ">Edit</a>
                                           <a href="<?php echo base_url();?>index.php/admin/delete_comment/<?php echo $row['id'] ?>" class="btn btn-danger " onClick="return doconfirm();">Delete</a>
                                      </td>   
               </tr>
               <?php }?>
              </tbody>

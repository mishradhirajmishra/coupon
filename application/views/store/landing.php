<html lang="en" class=" js no-touch"><!--<![endif]--><head>

    <!-- Basic -->
    <meta charset="utf-8">
    <title>Crossway - Startup Responsive HTML5 Template</title>
    <meta name="author" content="DSA79">
    <meta name="keywords" content="responsive, html5 template, one page, startup, business, company, corporate, creative">
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="intro_description" class="col-sm-7 col-md-7 animated fadeInLeft">
                    ...
                    <!-- Intro Section Title -->
                    <h1><strong>CrossWay</strong> is the Most <strong>Simple Way</strong> to launch your <strong>startup</strong></h1>
                    ...
                    <div id="quote_holder">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <!--Testimonial #2 -->
                                <li class="" style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.00316406;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                ...
                                <!--Testimonial #3 -->
                                <li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.996836;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
            ...
            <div id="clients-holder" class="row">
                <div class="col-md-12">
                    ...
                    <div id="our-customers" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
                        ...
                        <!-- Client Logo #1-->
                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 3040px; left: 0px; display: block;"><div class="owl-item" style="width: 190px;"><div id="client-logo-1" class="item">
                    ...
                    <div id="quote_holder">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <!--Testimonial #1 -->
                                <li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.996975;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                            <a href="#">@ Numquam eius modi tempora incidunt, labore dolore magnam aliquam quaerat voluptatem labore voluptatem.</a>
                                        </blockquote>
                                ...
                                <!--Testimonial #3 -->
                                <li class="" style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.003025;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                            <a href="#">@Praesent semper, lacus sed cursus porta, odio augue feugiat tincidunt ligula massa in primis faucibus posuere cubilia.</a>
                                        </blockquote>

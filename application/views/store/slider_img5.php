            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        echo form_open_multipart('dcount/update_slider5_img', $attributes); ?>
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <tr>
                                <td><img class="s_img2" src="<?php echo base_url("uploads/" . $cat_list['s_img5']) ?>">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="file" class="span11" name="s_img5"></td>
                                <input type="hidden" class="span11" value="<?php echo $cat_list['cat_id'] ?>"
                                       name="cat_id">
                            </tr>
                            <tr>
                                  <td>Store Url &nbsp;: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="url" class="span11" name="s_url" value="<?php echo $cat_list['cimg5'] ?>"></td>
                            </tr>
                            <tr>
                                <td>

                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/update_slider1/<?php echo $cat_list['cat_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/update_slider2/<?php echo $cat_list['cat_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/update_slider3/<?php echo $cat_list['cat_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/update_slider4/<?php echo $cat_list['cat_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/update_slider5/<?php echo $cat_list['cat_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/update_slider6/<?php echo $cat_list['cat_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                            </tr>

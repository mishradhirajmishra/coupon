...
-                                 <?php foreach($img as $row){?>
         <tr >
                      ...
                      <td > <img style="width:150px" src="<?php echo base_url("uploads2/".$row['img1']) ?>"> </td>
                       <td > <img style="width:150px" src="<?php echo base_url("uploads2/".$row['img2']) ?>"> </td>
                        <td > <img style="width:150px" src="<?php echo base_url("uploads2/".$row['org']) ?>"> </td>

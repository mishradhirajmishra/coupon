  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
              <div class="span6 offset3">
	                        	...
	                        	<?php } ?>
	                        			                       	<?php if($message==4){?>
	                        	<div class="alert alert-danger "><h3 style="text-align:center"> Image <strong>size </strong>must be  480 x 300 !</h3></div>
	                        	<?php } ?>
              </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <?php $attributes = array('class' => 'form-horizontal', 'id' => 'myform');
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" id"show" placeholder="Category " name="cat_type" required >
                                </div>
                            </div>
                            <span style="float:right;margin-right:35px;" class="alert alert-danger" >Image Size 480 X 300 </span>
                            <div class="control-group" >
...
-                                 <?php foreach($category as $row){?>
         <tr >
                     <td > <img style="width:150px" src="<?php echo base_url("uploads/".$row['cat_image']) ?>"> </td>
                                    <td > <?php echo $row['cat_name'] ?> </td>
                                    <td > <?php echo $row['cat_type'] ?> </td>
                                    <td > <?php echo $row['cat_date'] ?> </td>
                                    <td> <?php if( $row['cat_status']==0){echo'<button class="btn btn-info">No</button> ';} else {echo'<button class="btn btn-success">Yes</button> ';}?> </td>
                                      <td> <a href="<?php echo base_url();?>index.php/admin/edit_category/<?php echo $row['cat_id'] ?>" class="btn btn-primary ">Edit</a>
                                           <a href="<?php echo base_url();?>index.php/admin/delete_category/<?php echo $row['cat_id'] ?>" class="btn btn-danger " onClick="return doconfirm();">Delete</a>
                                      </td>   
               </tr>
               <?php }?>
              </tbody>

            ...
            <div class="span4">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        echo form_open_multipart('dcount/update_gallery6_img', $attributes); ?>
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <tr>
                                <td><img class="s_img1" src="<?php echo base_url("uploads/" . $store_list['gal6']) ?>">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="file" class="span11" name="gal6"></td>

            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        echo form_open_multipart('dcount/update_slider2_img', $attributes); ?>
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td><input type="file" class="span11" name="s_img2"></td>
                                <input type="hidden" class="span11" value="<?php echo $cat_list['cat_id'] ?>"
                                       name="cat_id">
                            </tr>
                            <tr>
                                  <td>Store Url &nbsp;: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="url" class="span11" name="s_url" value="<?php echo $cat_list['cimg2'] ?>"></td>
                            </tr>
                            <tr>
                                <td>

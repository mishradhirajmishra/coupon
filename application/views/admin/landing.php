...
<head>
    ...
    <!-- Basic -->
    <meta charset="utf-8">
    <title>Crossway - Startup Responsive HTML5 Template</title>
    <meta name="author" content="DSA79">
    <meta name="keywords"
          content="responsive, html5 template, one page, startup, business, company, corporate, creative">
    <meta name="description" content="Crossway - Startup Responsive HTML5 Template">
        ...
        <div class="container">
            ...
            <nav id="navigation-menu" class="collapse navbar-collapse" role="navigation">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a id="GoToAbout" href="#about-1" class="">About</a></li>
...
<div id="content-wrapper">
    ...
    <section id="intro" class="intro-parallax" style="background-position: 50% 34px;">
        <div class="container">
            <div class="row">

                <!-- Intro Section Description -->
                <div id="intro_description" class="col-sm-7 col-md-7 animated fadeInLeft">

                    <!-- Intro Section Title -->
                    <h1><strong>CrossWay</strong> is the Most <strong>Simple Way</strong> to launch your
                        <strong>startup</strong></h1>

                    <!-- Description #1 -->
                    <div class="intro_feature">
                        <h4><i class="fa fa-check"></i> Lorem ipsum consectetur adipisicing dolor</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua ullamco laboris aliquipea commodo consequat.
                        </p>
                    </div>

                    <!-- Description #2 -->
                    <div class="intro_feature">
                        <h4><i class="fa fa-check"></i> Lorem ipsum dolor amet, consectetur adipisicing</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua ullamco laboris aliquipea commodo consequat.
                        </p>
                    </div>
                    ...
                    <!-- Description #3 -->
                    <div class="intro_feature">
                        <h4><i class="fa fa-check"></i> Lorem ipsum dolor, consectetur adipisicing</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua ullamco laboris aliquipea commodo consequat.
                        </p>
                    </div>
                ...
                <!-- Intro Section Form -->
                <div id="intro_form" class="col-sm-5 col-md-5 animated fadeInRight">

                    <!-- Register Form -->
                    <div class="form_register">
                        <h2> Register Now! </h2>

                        <form action="contact.php" name="contactform" class="row" method="post" novalidate="novalidate">
                            ...
                            <div id="input_message" class="col-md-12">
                                <textarea id="comments" class="form-control" name="message" rows="6"
    ...
    <section id="about-1">
        <div class="container">
            ...
            <div class="row">
                ...
                <!--  ABOUT-1 TEXT -->
                <div id="about-1-text" class="col-md-6 animated fadeInLeft">
                ...
                <!-- ABOUT-1 IMAGE -->
                <div id="about-1-img" class="col-md-6 text-center animated fadeInRight">
    ...
    <section id="about-2">
        <div class="container">
            <div class="row">
                ...
                <!-- EMBEDDED VIDEO -->
                <div id="video_holder" class="col-md-6 animated fadeInLeft">
                ...
                <!--  ABOUT-2 TEXT -->
                <div id="about-2-text" class="col-md-6 animated fadeInRight">
                    <h4>Our Philosophy</h4>

                    <p>Nemo enim ipsam voluptatem, quia voluptas sit, aspernatur aut odit aut fugit, sed quia
                        consequuntur magni
                        dolores ratione voluptatem nesciunt, neque porro quisquam dolore magnam aliquam quaerat
                        voluptatem.
                    ...
                    <div id="quote_holder">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <li class=""
                                    ...
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                            <a href="#">@ Numquam eius modi tempora incidunt, labore dolore magnam
                                                aliquam quaerat voluptatem labore voluptatem.</a>
                                        </blockquote>
                                ...
                                <!--Testimonial #2 -->
                                <li class=""
                                    style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.00316406;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                            <a href="#">@Nemo voluptatem, quia voluptas, aspernatur consequuntur magni
                                                dolores ratione voluptatem nesciunt.</a>
                                        </blockquote>
                                ...
                                <li class="flex-active-slide"
                                    style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.996836;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                            <a href="#">@Praesent semper, lacus sed cursus porta, odio augue feugiat
                                                tincidunt ligula massa in primis faucibus posuere cubilia.</a>
                                        </blockquote>
            ...
            <div class="row">
                ...
                <div id="question_1" class="col-md-6">
                    <div class="question">
                        ...
                        <p>Praesent semper, lacus sed cursus porta, odio augue feugiat eros, ac tincidunt ligula massa
                            in est.
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
                            Etiam ut mi sit amet mauris suscipit
                ...
                <div id="question_2" class="col-md-6">
                    <div class="question">
                        ...
                        <p>Praesent semper, lacus sed cursus porta, odio augue feugiat eros, ac tincidunt ligula massa
                            in est.
                            Vestibulum ante ipsum primis in faucibus bibendum sit amet in odio. Integer congue leo
                            metus, eu mollis lorem viverra nec.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div id="question_4" class="col-md-6">
                    <div class="question">
                        ...
                        <p>Praesent semper, lacus sed cursus porta, odio augue feugiat eros. Vestibulum ante ipsum
                            primis in faucibus orci luctus et
                            ultrices posuere cubilia Curae; Etiam ut mi sit amet mauris suscipit bibendum sit amet in
                            odio. Integer congue leo metus, mollis lorem viverra.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 titlebar">
                    ...
                    <p>Aliquam a augue suscipit, bibendum luctus neque. Vestibulum laoreet rhoncus ipsum, bibendum
                        ullamcorper hendrerit tellus</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 titlebar">
                    ...
                    <p>Praesent semper, lacus sed cursus porta, augue feugiat tincidunt ligula massa faucibus posuere
                        cubilia </p>
                </div>
            </div>    <!-- End Section Tittle -->
            ...
            <div class="row">
                    ...
                    <article id="blog_post_1" class="blog-post">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="blog-post-img">
                                <img class="img-responsive" src="img/blog/img1.jpg" alt="Blog Image">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="blog-post-desc">
                                <p>Praesent augue arcu, ornare ut tincidunt eu, mattis a libero. Pellentesque habitant
                                    morbi tristique senectus et netus et malesuada fames ac turpis egestas... </p>
                            </div>

                            <!-- Post Meta -->
                            <div class="blog-post-info">
                                24 Apr 2014 / By <span class="theme-color">Admin</span> / <a
                                        href="single-post.html#post_comments" title="comments">19 Comments</a>
                            </div>
                ...
                <div class="col-sm-6 col-md-6">
                    <article id="blog_post_2" class="blog-post">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="blog-post-img">
                                <img class="img-responsive" src="img/blog/img2.jpg" alt="Blog Image">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            ...
                            <!-- Post Meta -->
                            <div class="blog-post-info">
                                15 Apr 2014 / By <span class="theme-color">Admin</span> / <a
                                        href="single-post.html#post_comments" title="comments">23 Comments</a>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6">
                    <article id="blog_post_3" class="blog-post">
                        ...
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="blog-post-info">
                                15 Apr 2014 / By <span class="theme-color">Admin</span> / <a
                                        href="single-post.html#post_comments" title="comments">33 Comments</a>
                            </div>
                ...
                <div class="col-sm-6 col-md-6">
                    <article id="blog_post_4" class="blog-post">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="blog-post-img">
                                <img class="img-responsive" src="img/blog/img3.jpg" alt="Blog Image">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            ...
                            <!-- Post Titlebar -->
                            <div class="blog-post-titlebar">
                                <h4><a href="single-post.html">Curabitur pulvinar tellus vitae sollicitudin pretium</a>
                                </h4>
                            </div>
                            ...
                            <!-- Post Meta -->
                            <div class="blog-post-info">
                                25 Mar 2014 / By <span class="theme-color">Admin</span> / <a
                                        href="single-post.html#post_comments" title="comments">41 Comments</a>
                            </div>
        ...
        <div class="container">
            ...
            <div id="clients-holder" class="row">
                <div class="col-md-12">
                    ...
                    <!-- Clients Carousel-->
                    <div id="our-customers" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
                            ...
                            <div class="owl-wrapper" style="width: 3040px; left: 0px; display: block;">
                                <div class="owl-item" style="width: 190px;">
                                    <div id="client-logo-1" class="item">
                                        <img class="img-responsive img-customer" src="img/thumbs/client-1.png"
                                             alt="customer_image">
                                    </div>
                                </div>
                                <div class="owl-item" style="width: 190px;">
                                    <div id="client-logo-2" class="item">
                                        <img class="img-responsive img-customer" src="img/thumbs/client-2.png"
                                             alt="customer_image">
                                    </div>
                                </div>
                                <div class="owl-item" style="width: 190px;">
                                    <div id="client-logo-3" class="item">
                                        <img class="img-responsive img-customer" src="img/thumbs/client-3.png"
                                             alt="customer_image">
                                    </div>
                                </div>
                                <div class="owl-item" style="width: 190px;">
                                    <div id="client-logo-4" class="item">
                                        <img class="img-responsive img-customer" src="img/thumbs/client-4.png"
                                             alt="customer_image">
                                    </div>
                                </div>
                                <div class="owl-item" style="width: 190px;">
                                    <div id="client-logo-5" class="item">
                                        <img class="img-responsive img-customer" src="img/thumbs/client-5.png"
                                             alt="customer_image">
                                    </div>
                                </div>
                                <div class="owl-item" style="width: 190px;">
                                    <div id="client-logo-6" class="item">
                                        <img class="img-responsive img-customer" src="img/thumbs/client-6.png"
                                             alt="customer_image">
                                    </div>
                                </div>
                                <div class="owl-item" style="width: 190px;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <p>Praesent semper, lacus sed cursus porta, odio augue feugiat primis in faucibus ultrices posuere
                        cubilia Curae;
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="footer_nav" class="col-sm-6 col-md-4">
                    ...
                    <div id="footer_copy">
                        <p>© Copyright 2014 <span>Crossway</span> All Right Reserved</p>
                    </div>
                ...
                <div class="col-md-4">
                    <div id="newsletter_form" class="col-sm-12">
                        <div class="clearfix">
                            <form id="subscribe-form" class="subscribe-form pull-right" action="newsletter.php"
                                  method="post">
                        ...
                        <p id="newsletter-paragraph" class="pull-right">Join our newsletter subscription, <span>be always informed</span>
                        </p>
                    </div>
                    ...
                    <div id="quote_holder">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <!--Testimonial #1 -->
                                <li class="flex-active-slide"
                                    style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.996975;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                            <a href="#">@ Numquam eius modi tempora incidunt, labore dolore magnam
                                                aliquam quaerat voluptatem labore voluptatem.</a>
                                ...
                                <!--Testimonial #3 -->
                                <li class=""
                                    style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item; opacity: 0.003025;">
                                    <div class="testimonials">
                                        <blockquote class="quote-text">
                                            <a href="#">@Praesent semper, lacus sed cursus porta, odio augue feugiat
                                                tincidunt ligula massa in primis faucibus posuere cubilia.</a>

                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span11" placeholder="Location name" name="location_name"
                                       required>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <table class="table table-bordered data-table">
                            ...
                            <?php foreach ($location as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>index.php/admin/edit_location/<?php echo $row['loc_id'] ?>"
                                           class="btn btn-primary ">Edit</a>
                                        <?php if ($_SESSION['status'] == 0) { ?> <a
                                                href="<?php echo base_url(); ?>index.php/admin/delete_location/<?php echo $row['loc_id'] ?>"

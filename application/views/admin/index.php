    ...
    <div class="container-fluid">
        ...
        <div class="quick-actions_homepage">
            <ul class="quick-actions">
                <li class="bg_ly"><a href="<?php echo base_url(); ?>index.php/admin/add_store"> <i
                                class="icon-inbox"></i><span class="label label-success"><?php echo $store ?></span>
                        Store </a></li>
                         <?php if ($_SESSION['status'] == 1) { ?>
                                      <li class="bg_lb"><a href=""> <i
                                class="icon-inbox"></i><span class="label label-success">Profile</span><i class="fa fa-user fa-2x"
                ...
                <li class="bg_lb"><a href="<?php echo base_url(); ?>index.php/admin/add_category"> <i
                                class="icon-tint"></i> <span
                                class="label label-warning"><?php $q = $this->db->get('category');
                            echo $q->num_rows(); ?></span>Categories </a></li>
                <li class="bg_lg"><a href="<?php echo base_url(); ?>index.php/admin/add_coupon"> <i
                                class="icon-dashboard"></i> <span
                                class="label label-important"><?php $q = $this->db->get('coupon');
                            echo $q->num_rows(); ?></span>Coupons </a></li>
                <li class="bg_lr"><a href="<?php echo base_url(); ?>index.php/admin/code_reg_user"> <i
                                class="icon-pencil"></i><span class="label label-danger"><?php echo $user ?></span>
                        Uesrs </a></li>
                          <?php } ?>
                        ...
                        <div class="span9">
                            <div class="chart">
                                <iframe width="600" height="371" seamless frameborder="0" scrolling="no"
                                        src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRk6-J-irixmXCkU-u9BRnnIOUGyn9T6v8LvXGT7vyf74AA6EJbqxAiNtUWMHl0Lz5IoXh_ID8Fj27c/pubchart?oid=789465274&amp;format=interactive"></iframe>
                            </div>
                        </div>
                        <div class="span3">
                            <!--<ul class="site-stats">

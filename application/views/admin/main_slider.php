            ...
            <div class="span6 offset6">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        echo form_open_multipart('admin/add_main_slider', $attributes); ?>
                            ...
                            - <?php foreach ($slider as $row) { ?>
                                <tr>
                                    ...
                                    <td> <?php echo $row['url'] ?> </td>
                                     <td>
                                        <a href="<?php echo base_url(); ?>index.php/admin/edit_main_slider/<?php echo $row['id'] ?>"
                                           class="btn btn-primary ">Edit</a>
                                        <a   href="<?php echo base_url(); ?>index.php/admin/delete_main_slider/<?php echo $row['id'] ?>"

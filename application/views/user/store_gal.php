                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img1/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img2/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img3/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img4/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img5/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img6/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img7/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img8/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/dcount/change_gal_img9/<?php echo $store_list['st_id'] ?>"
                                       class="btn btn-primary ">Change Immage</a></td>
                            </tr>

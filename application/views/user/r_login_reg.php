      	...
      	<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
				      <h4>Register Now</h4>
               						<?php $attributes = array('style' => 'padding: 20px; 0px 40px 0px', 'id' => 'register-form'); echo form_open('User/signup_user_r',$attributes);?>
									...
									<div class="form-group"style="display:none">
									   ...
									   <input type="text" name="form-ref" id="form-ref" tabindex="2" class="form-control" value="<?php echo $this->uri->segment(3, 0); ?>">
									</div>
									<div class="form-group">
